...
* Interactive Featured Models section with automatic car rotation
...
* Smooth fade transitions between vehicle models
...
* Include detailed pages for each Audi model
